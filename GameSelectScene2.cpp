...
GameSelectScene2::GameSelectScene2()
{
	//LoadTexture(L"assets/TitleGround.png", &gpTextureStageSelect01);
	LoadTexture(L"assets/Select_BG.png", &gpTextureBackGround);

	LoadTexture(L"assets/stage_2-1.png", &gpTextureSelect01);
	LoadTexture(L"assets/stage_2-2.png", &gpTextureSelect02);
	LoadTexture(L"assets/stage_2-3.png", &gpTextureSelect03);
