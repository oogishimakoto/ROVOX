...
Stage1_1::Stage1_1()
{
	...
	//マップチップファイル読み込み
	maptip = new MaptipFileRead("assets/Map_CSV/Stage1-1.csv");
...
Stage1_1::~Stage1_1()
{
	...
	// 小物
	COM_SAFE_RELEASE(gpTextureGoal);	// *
	COM_SAFE_RELEASE(gpTextureKey);		// *
	COM_SAFE_RELEASE(gpTextureMapTipHouse03);	// *
	//UI
	...
	COM_SAFE_RELEASE(gpTextureUI06);	// *
	COM_SAFE_RELEASE(gpTextureUI07);	// *
	//GearUI
	COM_SAFE_RELEASE(gpTextureGearUI01);
	COM_SAFE_RELEASE(gpTextureGearUI02);
	COM_SAFE_RELEASE(gpTextureGearUI03);
	COM_SAFE_RELEASE(gpTextureGearUI04);
	COM_SAFE_RELEASE(gpTextureGearUI05);

	COM_SAFE_RELEASE(gpTextureDoolFallRight);
	COM_SAFE_RELEASE(gpTextureBox);
	COM_SAFE_RELEASE(gpTextureBox2);	// *
	COM_SAFE_RELEASE(gpTextureBox3);	// *
	...
	// ポーズ系
	COM_SAFE_RELEASE(gpTexturepauseMenu);		//*
